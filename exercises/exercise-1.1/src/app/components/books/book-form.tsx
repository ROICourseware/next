...
import useImageConverter, { ImageSize} from "@/app/components/utilities/use-image-converter";
...
export default function BookForm({book}: {book : Book}) {
    ...
    const [imageSize, setImageSize] = useState<ImageSize>([248, 248]);
    const [height, width] = imageSize;
    const setImage = (dataUrl: string) => { book.cover = dataUrl; }
    const imageRef = useImageConverter(248, setImageSize, setImage);
    ...
    return (
        <form action={formAction} className="mt-4 row">
            ...
            <div>
                ...
                <input className="form-control form-control-lg" type="file" id="coverinput" ref={imageRef}  />
